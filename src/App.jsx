...
function App() { 
  ...
  return (
    ...
    <Navbar/> 
       ...
       <div className="mx-3 md:container md:mx-auto bg-gradient-to-b from-gray-500 to-gray-200 backdrop-blur-sm border-2 border-gray-200 rounded-lg shadow-md my-5 p-5 min-h-[80vh] md:w-[35%]">
        <h1 className='font-bold text-center text-3xl'>iTask - Manage my todos at one place</h1>
